...
- **Wayback Machine** – to grab an old snapshot of the site.  
- **JPEXS Free Flash Decompiler** – to extract the audio files from the original `.swf`. ([GitHub](https://github.com/jindrapetrik/jpexs-decompiler))

All audio is included in the `sounds/` folder.
...
- Click **“Enable sounds”** on first visit (required by browsers to play audio).  
